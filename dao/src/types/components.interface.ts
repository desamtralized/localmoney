...
export type ProposalMsgBankSend = {
  bank: {
    send: {
      to_address: string;
      amount: {
...
export type ProposalMsgWasmExecute = {
  wasm: {
    execute: {
      contract_addr: string;
      msg: string;
      funds: any[]; // Define the structure of funds if needed
    };
  };
};
...
export type Proposal = {
  ...
  title: string;
  description: string;
  msgs: (ProposalMsgBankSend | ProposalMsgWasmExecute)[];
  status: string;
  expires: {
    at_time: string;
  };
